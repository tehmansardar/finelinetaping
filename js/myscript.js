...
$(function () {
  ...
  $('ul.categories-filters li').addClass('grid_sorting_button button d-flex flex-column justify-content-center align-items-center');
  $('ul.categories-filters li:first').addClass('active');
  ...
  $cat_links.on('click', function (e) {
    ...
    if (el == 'All') {
      $('.containers .post-categories').show();
    } else {
      $('.containers .post-categories').not('.' + el).hide();
      $('.containers').find('.' + el).show();
    }
  }) 
  ...
  $('.projectItem').on('click',function(e){
  	...
  	$('.popup-display').removeClass('displaying');
  	$('.mfp-figure img').attr('src', imgSrc);
  })
  
  $(document).on('click', '.mfp-close', function(e){
  	e.preventDefault();
  	$('.popup-display').addClass('displaying');
  })

  // Get year for footers
  var d = new Date();
  var n = d.getFullYear();
  $('#setYear').text(n);
...
jQuery(document).ready(function ($) {
  ...
  $('.services-1').on('click', function () {

    var domainUrl = $('.services-img1').data('i1');
    //alert(domainUrl);
    $('.services-img1').attr('src', domainUrl + 'assets/images/interior-services/investor_home48.JPG');
    $('.services-img2').attr('src', domainUrl + 'assets/images/interior-services/investor_home49.JPG');
  })
  $('.services-2').on('click', function () {

    var domainUrl = $('.services-img1').data('i1');
    //alert(domainUrl);
    $('.services-img1').attr('src', domainUrl + 'assets/images/interior-services/investor_home_con.jpg');
    $('.services-img2').attr('src', domainUrl + 'assets/images/interior-services/investor_home_con1.jpeg');
  })
  $('.services-3').on('click', function () {

    var domainUrl = $('.services-img1').data('i1');
    //alert(domainUrl);
    $('.services-img1').attr('src', domainUrl + 'assets/images/interior-services/investor_home_reno.jpg');
    $('.services-img2').attr('src', domainUrl + 'assets/images/interior-services/investor_home_reno2.jpg');
  })
  $('.services-4').on('click', function () {

    var domainUrl = $('.services-img1').data('i1');
    //alert(domainUrl);
    $('.services-img1').attr('src', domainUrl + 'assets/images/interior-services/investor_home_91.jpg');
    $('.services-img2').attr('src', domainUrl + 'assets/images/interior-services/investor_home_92.jpg');
  })
  $('.services-5').on('click', function () {

    var domainUrl = $('.services-img1').data('i1');
    //alert(domainUrl);
    $('.services-img1').attr('src', domainUrl + 'assets/images/interior-services/investor_home_1.jpg');
    $('.services-img2').attr('src', domainUrl + 'assets/images/interior-services/investor_home_2.jpg');
  })
  $('.services-6').on('click', function () {

    var domainUrl = $('.services-img1').data('i1');
    //alert(domainUrl);
    $('.services-img1').attr('src', domainUrl + 'assets/images/interior-services/investor_home_16.JPG');
    $('.services-img2').attr('src', domainUrl + 'assets/images/interior-services/investor_home_18.JPG');
  })



  // Contact From Submission
  $('#finelineContactFrom').on('submit', function (e) {
    e.preventDefault();
    var form = $(this),
    ...
    // var rn = /^[A-Za-z ]+$/
    // console.log( rn.test(name) );

    var rm = /^[A-Za-z ,.'"@&()-_=;:*+0-9]+$/
    console.log(rm.test(message));
    // var re = /^(([^<>()\[\]\.,;:\s@\"]+(\.[^<>()\[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i;
    ...
    $.ajax({
      ...
      data: {
        ...
        email: email,
        message: message,
        action: 'finelinetaping_contact_form'
      },
      error: function (response) {
        console.log('Unable to submit message');
      },
      success: function (response) {
        $('#finelineContactFrom')[0].reset();
...
function initMap() {
  ...
  var uluru = { lat: 30.666766, lng: 73.110752 };
